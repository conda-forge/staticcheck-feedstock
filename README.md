...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/staticcheck-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/staticcheck-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add staticcheck
# for installing globally
pixi global install staticcheck
```
...
It is possible to list all of the versions of `staticcheck` available on your platform:
...
```
pixi search staticcheck --channel conda-forge
```
